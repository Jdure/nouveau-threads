export default function Footer() {
  return (
    <footer className="text-hover body-font">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <p className="text-sm text-neutral sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          ...
          <span className="ml-3 text-neutral">
            <svg
              fill="currentColor"
              strokeLinecap="round"
              strokeLinejoin="round"
