              ...
              <div className="pointer-events-auto w-screen max-w-md">
                <div className="flex h-full flex-col overflow-y-scroll bg-teal-50 shadow-xl">
                  ...
                  <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                    ...
                    <div className="mt-6">
                      <button className="flex items-center font-bold justify-center rounded-md btn-primary px-6 py-3 font-medium text-base-100">
                    ...
                    <div className="mt-6 flex justify-center text-center text-sm text-neutral">
                      <p>
                        ...
                        <button
                          ...
                          type="button"
                          className="btn-primary btn-link text-sm rounded-none"
                          onClick={cartOpenFunc}
                        >
                          Continue Shopping
